...
from old.chatgroup import MagenticOneGroupChat
from autogen_agentchat.conditions import TextMentionTermination

# custom agent imports
from surfline_agent import SurflineAgent
...
async def main() -> None:
    ...
    surfline_agent = SurflineAgent(
        ...
        description="An agent that queries surfline.com for up-to-date surf conditions and recommendations",
    )
